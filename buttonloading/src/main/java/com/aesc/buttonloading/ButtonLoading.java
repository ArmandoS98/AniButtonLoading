package com.aesc.buttonloading;
...
public class ButtonLoading extends RelativeLayout implements View.OnClickListener {
    ...
    String TAG = ButtonLoading.class.getSimpleName();
    /**
    ...
    private void setAttrs(AttributeSet attrs, Context context) {
        ...
        buttonLabel = typedArray.getString(R.styleable.MyLoadingButton_label);
        animationTime = typedArray.getInteger(R.styleable.MyLoadingButton_animationDuration, animationTime);
        buttonBackgroundColor = typedArray.getColor(R.styleable.MyLoadingButton_backgroundColor, DEFAULT_BUTTON_COLOR);
        loaderColor = typedArray.getColor(R.styleable.MyLoadingButton_loaderColor, DEFAULT_LOADER_COLOR);
        buttonLabelSize = typedArray.getDimension(R.styleable.MyLoadingButton_labelSize, DEFAULT_BUTTON_LABEL_SIZE);
        buttonLabelColor = typedArray.getColor(R.styleable.MyLoadingButton_labelColor, DEFAULT_BUTTON_LABEL_COLOR);
        progressErrorDrawable = typedArray.getDrawable(R.styleable.MyLoadingButton_setErrorIcon);
        progressDoneDrawable = typedArray.getDrawable(R.styleable.MyLoadingButton_setDoneIcon);
        normalAfterError = typedArray.getBoolean(R.styleable.MyLoadingButton_setNormalAfterError, true);
     ...
     * @return
     */
    public ButtonLoading setButtonLabel(String string) {
     ...
     * @return
     */
    public ButtonLoading setAnimationDuration(int animDuration) {
     ...
     * @return
     */
    public ButtonLoading setButtonColor(int buttonColor) {
     ...
     * @param mColor
     */
    public ButtonLoading setProgressLoaderColor(int mColor) {
     ...
     * @return
     */
    public ButtonLoading setButtonLabelSize(float size) {
     ...
     * @return
     */
    public ButtonLoading setButtonLabelColor(int mColor) {
     ...
     * @return
     */
    public ButtonLoading setProgressErrorIcon(Drawable errorIcon) {
     ...
     * @return
     */
    public ButtonLoading setProgressDoneIcon(Drawable doneIcon) {
     ...
     * @return
     */
    public ButtonLoading setNormalAfterError(boolean toNormal) {
